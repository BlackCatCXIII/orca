...
export const remoteEnvironmentWorkspacesCopy = {
  loadError: translate(
  ...
  resume: translate('auto.components.settings.RemoteEnvironmentWorkspacesSection.resume', 'Resume'),
  destroy: translate(
  ...
  cancel: translate('auto.components.settings.RemoteEnvironmentWorkspacesSection.cancel', 'Cancel')
} as const
